...
{{- if .Values.global.launchedByInstaller -}}
    {{ default (include "prometheus.alertmanager.fullname" .) .Values.serviceAccounts.alertmanager.name }}
{{- else -}}
    {{ default "suite-monitoring-serviceaccount" .Values.serviceAccounts.alertmanager.name }}
{{- end -}}
{{- end -}}
...
{{- else -}}
    {{ default "suite-monitoring-serviceaccount" .Values.serviceAccounts.kubeStateMetrics.name }}
{{- end -}}
{{- end -}}
...
{{- else -}}
    {{ default "suite-monitoring-serviceaccount" .Values.serviceAccounts.nodeExporter.name }}
{{- end -}}
{{- end -}}
...
{{- else -}}
    {{ default "suite-monitoring-serviceaccount" .Values.serviceAccounts.pushgateway.name }}
{{- end -}}
{{- end -}}
...
{{- else -}}
    {{ default "suite-monitoring-serviceaccount" .Values.serviceAccounts.server.name }}
{{- end -}}
{{- end -}}
